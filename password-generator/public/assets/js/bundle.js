...
/* harmony import */ var _modules_password_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/password.js */ "./src/modules/password.js");



function main() {
  var display = document.querySelector('.display');
  var lenInput = document.querySelector('#len');
  var numberInput = document.querySelector('#number');
  var lowerInput = document.querySelector('#lower');
  var upperInput = document.querySelector('#upper');
  var specialCharInput = document.querySelector('#special');
  var activationBtn = document.querySelector('#activate-btn');
  ...
  function handleClick() {
    ...
    try {
      var password = Object(_modules_password_js__WEBPACK_IMPORTED_MODULE_1__["default"])({
        len: lenInput.value,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return createNewPassword; });
function createNewPassword(_ref) {
  var len = _ref.len,
      ...
      _ref$specialChar = _ref.specialChar,
      specialChar = _ref$specialChar === void 0 ? false : _ref$specialChar;
  if (len < 4 || len > 30) throw new RangeError('Password must contain beetween 4 and 30 chars!');
  if (!(number || lower || upper || specialChar)) throw new Error('You must activate at least one the options!');
  var newPassword = '';
  var i = 0;
  ...
  function getLowerLetter() {
    var charCode = getRandomNumber(97, 122);
    return String.fromCharCode(charCode);
  }

  function getUpperLetter() {
    var charCode = getRandomNumber(65, 90);
    return String.fromCharCode(charCode);
  }

  function getSpecialChar() {
    var options = "+-=_!@#$%&*()?|\/<>{}[]:;";
    var index = getRandomNumber(0, options.length - 1);
